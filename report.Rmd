...
We will now try to tackle some of the questions we were interested in. From our exploratory analysis, it seemed that males had a greater chance of being diagnosed. We now try to frame this in terms of the query "Is the coefficient of sex_male in our model greater than 0?$. We try to answer this in two ways:
...
2. *Decision Theory Framework*: We wish to make a decision whether $\beta_1 >0$. Define the loss function:
