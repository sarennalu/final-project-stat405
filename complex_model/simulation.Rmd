...
data_processed 
predictors = data_processed |> select(-CDR) |> mutate(across(Age: nWBV, scale))
...
We generate parameters and data according to our model many times. Then after fitting our model, what proportions of the times the 95%credible interval for the parameter is able to capture the true value of the parameter. 
```{r}
Niter = 10
